...
UNITS = {
    ...
    'barg': Unit('barg', 'bar guage', M=1, L=-1, T=-2, 
                 coef=D('1E5'), offset=D('101325')),
    'psi': Unit('psi', 'pound per square inch', M=1, L=-1, T=-2, 
                coef=D('6894.7572932')),
    'psig': Unit('psig', 'pound per square inch guage', M=1, L=-1, T=-2, 
                 coef=D('6894.7572932'), offset=D('101325')),
    'kcs': Unit('kcs', 'kilogram per square centimeter', M=1, L=-1, T=-2, 
                coef=D('98066.5')),
    'kcsg': Unit('kcsg', 'kilogram per square centimeter guage', M=1, L=-1, T=-2, 
                 coef=D('98066.5'), offset=D('101325')),
    'kPag': Unit('kpag', 'kilogram per square centimeter guage', M=1, L=-1, T=-2, 
                 coef=D('1000'), offset=D('101325')),
    'torr': Unit('torr', 'torr', M=1, L=-1, T=-2, 
                 coef=D('133.3223684210526315789')),
    'inHg': Unit('inhg', 'inch of mercury', M=1, L=-1, T=-2, 
                 coef=D('133.3223684210526315789')),
    'mmWater': Unit('mmH2O', 'millimeter of water', M=1, L=-1, T=-2, 
                    coef=D('9.80665')),
    'min': Unit('min', 'minute', T=1, coef=D('60')),
    'h': Unit('h', 'hour', T=1, coef=D('3600')),
    'day': Unit('day', 'day', T=1, coef=D('86400')),
    'week': Unit('week', 'week', T=1, coef=D('604800')),
    'month': Unit('month', 'month', T=1, coef=D('2592000')),
    'year': Unit('year', 'year', T=1, coef=D('31536000')),
    'yr': Unit('yr', 'year', T=1, coef=D('31536000')),
    'degC': Unit('degC', 'degree celsius', THETA=1, offset=D('273.15')),
    'degF': Unit('degF', 'degree fahrenheit', THETA=1, 
                 offset=D('273.15') - D('32') / D('1.8'), coef=D('1') / D('1.8')),
    'cP': Unit('cP', 'centipoise', M=1, L=-1, T=-1, coef=D('1E-3'))
}
